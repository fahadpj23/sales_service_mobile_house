...
class AccessoriesServiceVerificationTab extends StatelessWidget {
  ...
  const AccessoriesServiceVerificationTab({
    Key? key,
  ...
  Widget _buildGenericSaleCard(
    ...
    Map<String, dynamic> displayData = _getAccessoriesServiceDisplayData(sale);
