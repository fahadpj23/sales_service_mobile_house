...
class TvVerificationTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _buildMobileListView(
      title: 'TV Verification',
      filteredData: filteredData,
      allData: allData,
      selectedShop: selectedShop,
      availableShops: availableShops,
      onShopChanged: onShopChanged,
      buildItem: (sale) => _buildTvSaleCard(sale, context),
      emptyMessage: 'No TV sales found for verification',
    );
  }
          ...
          children: [
            Row(
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.tv, size: 18, color: Colors.green[900]),
  ...
  Map<String, dynamic> _getTvDisplayData(Map<String, dynamic> sale) {
    return {
      ...
      'date': sale['createdAt'] ?? sale['date'] ?? sale['timestamp'],
    };
  }
}
