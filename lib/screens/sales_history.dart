...
class _SalesHistoryScreenState extends State<SalesHistoryScreen> {
  ...
  Future<void> _fetchWithAlternativeDateField(
    ...
    try {
      ...
      switch (collection) {
        case 'phoneSales':
          dateFields = ['createdAt', 'saleDate', 'addedAt'];
          break;
        default:
          dateFields = ['uploadedAt', 'timestamp', 'date'];
          break;
      }
      ...
      for (var dateField in dateFields) {
        try {
          ...
          print('Error with date field $dateField for $collection: $e');
        }
      }
    } catch (e) {
      print('Failed all date field attempts for $collection: $e');
    }
  }
