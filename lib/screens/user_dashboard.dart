  ...
  Widget _buildRecentSalesList() {
    ...
    if (filteredSales.isEmpty) {
      return Container(
        ...
        child: Column(
          children: [
            Icon(Icons.receipt, size: 40, color: Colors.grey.shade300),
            const SizedBox(height: 12),
            const Text(
              'No sales found',
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                            ...
                            _buildDrawerSection(
                              ...
                              children: [
                                ...
                                _buildDrawerTile(
                                  ...
                                  onTap: () {
                                    _scaffoldKey.currentState?.closeDrawer();
                                    _navigateToScreen(const TvStockScreen());
                                  },
                                ),
                                _buildDrawerTile(
                                  icon:
                      ...
                      // Logout button placed outside the scrollable area
                      Container(
      ...
      chips.add(
        Container(
          ...
          child: const Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(Icons.money, size: 9, color: Colors.grey),
              SizedBox(width: 2),
              Text(
                'Payment Info',
                style: TextStyle(fontSize: 8, color: Colors.grey),
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(_getPaymentIcon(method), size: 14, color: color),
              ),
              const SizedBox(width: 6),
              Text(
                method,
