...
class CreateAccessoryPurchaseForm extends StatelessWidget {
  ...
  // Removed updateItemHsnCode parameter

  const CreateAccessoryPurchaseForm({
    Key? key,
    ...
    // Removed updateItemHsnCode from constructor
  }) : super(key: key);
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                item.productName ?? 'Tap to select accessory *',
                                style: TextStyle(
                                  fontSize: 12,
                ...
                if (showEditSection && item.productId != null) ...[
                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      // Removed HSN Code field - now only 3 fields instead of 4
                    ],
                  ),
